...
@Component({
    selector: 'app-modal-report-cash-flow',
    templateUrl: './modal-report-cash-flow.component.html',
    styleUrls: ['./modal-report-cash-flow.component.css']
})
export class ModalReportCashFlowComponent implements OnInit {

    entidade = 'Relatório Fluxo de Caixa'
    @Input() dateStart;
    @Input() dateEnd;
    @Input() endpoint;
    @Input() nameFile;
