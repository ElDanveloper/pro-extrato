...
@Component({
    selector: 'app-empresas-cadastro3',
    templateUrl: './empresas-cadastro3.component.html',
    styleUrls: ['./empresas-cadastro3.component.css']
})

export class EmpresasCadastro3Component extends BaseFormPost implements OnInit, OnDestroy {
