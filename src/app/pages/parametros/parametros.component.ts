...
export class ParametrosComponent implements OnInit {
    ...
    constructor(public confirmationService: ConfirmationService, public networkService: NetworkService, public router: Router, private route: ActivatedRoute) {
    }

    currentIndex = 0
    activeItem: MenuItem;
    itemsTabMenu = [
        {label: 'Empresa', icon: 'fa fa-fw fa-building'},
        {label: 'Usuarios', icon: 'fa fa-fw fa-user'},
        {label: 'Parametros', icon: 'fa fa-fw fa-cogs'},
        // {label: 'Detalhamento', icon: 'fa fa-fw fa-file-text-o'},
        // {label: 'Nfe', icon: 'fa fa-book'},
        // {label: 'Com ST', icon: 'fa fa-fw fa-file-text'}
    ];
    ...
    setItem(index) {
        ...
        this.activeItem = this.itemsTabMenu[index]
    }
